...
namespace Kittens::ChaiScript {
    void update_setting_i(const std::string setting_name, int setting) {
        int i = 0;
        LOG(INFO) << "setting int " << setting_name << "(" << Kittens::Util::string_to_hex(setting_name) << ")" << std::endl;
    ...
    void update_setting_s(const std::string setting_name, std::string setting) {
        int i = 0;
        LOG(INFO) << "setting string " << setting_name << "(" << Kittens::Util::string_to_hex(setting_name) << ")" << std::endl;
    ...
    void update_setting_f(const std::string setting_name, float setting) {
        int i = 0;
        LOG(INFO) << "setting float " << setting_name << "(" << Kittens::Util::string_to_hex(setting_name) << ")" << std::endl;
    ...
    void update_setting_d(const std::string setting_name, double setting) {
        int i = 0;
        LOG(INFO) << "setting double " << setting_name << "(" << Kittens::Util::string_to_hex(setting_name) << ")" << std::endl;
    ...
    void update_setting_b(const std::string setting_name, bool setting) {
        int i = 0;
        LOG(INFO) << "setting bool " << setting_name << "(" << Kittens::Util::string_to_hex(setting_name) << ")" << std::endl;
